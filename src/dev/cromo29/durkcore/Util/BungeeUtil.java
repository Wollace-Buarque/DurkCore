...
public class BungeeUtil implements PluginMessageListener {
    ...
    /**
     * Get or create new BungeeUtil instance
     *
     * @param plugin the plugin instance.
     * @return the BungeeUtil instance for the {@code plugin}
    ...
    public void sendPluginMessage(String servidor, String subChannel, String message) {
        getPlayerCount(servidor).whenComplete((result, error) -> {
            if (result > 0) {
                ...
                getFirstPlayer().sendPluginMessage(this.plugin, "BungeeCord", out.toByteArray());
            }
        });
    }
