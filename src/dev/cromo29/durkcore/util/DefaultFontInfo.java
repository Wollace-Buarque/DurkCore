...
public enum DefaultFontInfo {
    ...
    EXCLAMATION_POINT('!', 1), AT_SYMBOL('@', 6),
    NUM_SIGN('#', 5), DOLLAR_SIGN('$', 5),
    PERCENT('%', 5), UP_ARROW('^', 5),
    AMPERSAND('&', 5), ASTERISK('*', 5),
    LEFT_PARENTHESIS('(', 4), RIGHT_PERENTHESIS(')', 4),
    MINUS('-', 5), UNDERSCORE('_', 5),
    PLUS_SIGN('+', 5), EQUALS_SIGN('=', 5),
    ...
    public int getBoldLength() {
        if (this == DefaultFontInfo.SPACE) return getLength();
        return length + 1;
    }
